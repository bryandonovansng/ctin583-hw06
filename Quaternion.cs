...
public class Quaternion : MonoBehaviour
{
    ...
    public Vector3 rotationAxis = Vector3.up; // Default axis is Y-axisn
    public int rotationAngle = 15; //setting angle of rotation
    public Vector3 startRotation = (0, 0, 0); //setting the start rotation 
    public Vector3 endRotation = (100, 100, 100); //setting the end rotation 
    
    // TODO: Problem 2: Define two Quaternions
    public Quaternion quaternion1 = Quaternion.identity;

    public Quaternion quaternion2 = Quaternion.identity;
    ...
    void Update()
    {
        ...
        quaternion1 = Quaternion.Euler(rotationAxis * rotationAngle);
        quaternion2 = Quaternion.Euler(rotationAxis * rotationAngle);
        Quaternion tempQuaternion = quaternion1 * quaternion2;
        ...
        {
            Debug.Log("quaternion 1 and quaternion 2 are Equal")
        }
        else
        {
        ...
        Quaternion.Lerp(startRotation, endRotation, 1);
    }
}
